...
if(grab == true && trgButton == true  ) Serial.println((String)"A"+flexADC+"B"+flexADC1+"C"+flexADC2+"D"+flexADC3+"E"+flexADC4+"F"+X_PIN_Value+"G"+Y_PIN_Value+"I"+"L");
if(grab == true && trgButton == false  ) Serial.println((String)"A"+flexADC+"B"+flexADC1+"C"+flexADC2+"D"+flexADC3+"E"+flexADC4+"F"+X_PIN_Value+"G"+Y_PIN_Value+"L");
if(grab == false && trgButton == true  ) Serial.println((String)"A"+flexADC+"B"+flexADC1+"C"+flexADC2+"D"+flexADC3+"E"+flexADC4+"F"+X_PIN_Value+"G"+Y_PIN_Value+"I");
if(grab == false && trgButton == false  ) Serial.println((String)"A"+flexADC+"B"+flexADC1+"C"+flexADC2+"D"+flexADC3+"E"+flexADC4+"F"+X_PIN_Value+"G"+Y_PIN_Value);
